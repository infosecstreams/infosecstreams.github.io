...
activityData = list(sorted([(*querySullyGnomeActivityStats(*getScrapeData(username)),extraData) for username,extraData in getTwitchUsernames()], key=lambda x: x[1], reverse=True))
