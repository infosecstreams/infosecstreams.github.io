...
🟢 | `CosmodiumCS` | [<i class="fab fa-twitch" style="color:#9146FF"></i>](https://www.twitch.tv/CosmodiumCS "Science & Technology, Tags: cybersecurity, hacking, coding, malware, HackTheBox, hacktheplanet, tryhackme, security") &nbsp; [<i class="fab fa-youtube" style="color:#C00"></i>](https://www.youtube.com/CosmodiumCS)| EN
