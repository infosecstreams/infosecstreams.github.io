...
🟢 | `Elustaani` | [<i class="fab fa-twitch" style="color:#9146FF"></i>](https://www.twitch.tv/Elustaani "Science & Technology, Tags: singleplayer, Suomi, anime, hacking, kali, Linux") &nbsp; [<i class="fab fa-youtube" style="color:#C00"></i>](https://www.youtube.com/@elustaani) | FI
