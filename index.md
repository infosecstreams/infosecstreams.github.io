...
🟢 | `ProfitzTV` | [<i class="fab fa-twitch" style="color:#9146FF"></i>](https://www.twitch.tv/ProfitzTV "Software and Game Development, Tags: English, TheBaldDev, GameDev, Godot4, CSharp, Python, cybersecurity") &nbsp; [<i class="fab fa-youtube" style="color:#C00"></i>](https://www.youtube.com/@profitztv) | EN
