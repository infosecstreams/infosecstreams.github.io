...
🟢 | `LaurieWired` | [<i class="fab fa-twitch" style="color:#9146FF"></i>](https://www.twitch.tv/LaurieWired "Software and Game Development, Tags: computer, adhd, pagan, hacking, bugbounty, bug, bounty, ethical, hacktheplanet") &nbsp; [<i class="fab fa-youtube" style="color:#C00"></i>](https://www.youtube.com/@lauriewired) | EN
