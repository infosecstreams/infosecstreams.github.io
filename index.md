...
🟢 | `PentesterTV` | [<i class="fab fa-twitch" style="color:#9146FF"></i>](https://www.twitch.tv/PentesterTV "Software and Game Development, Tags: infosec, cybersecurity, hacking, pentest, security, ctf, hackthebox, tryhackme, appsec, English") &nbsp; [<i class="fab fa-youtube" style="color:#C00"></i>](https://www.youtube.com/@pentestertv) | EN
