...
🟢 | `S1y_b0rg` | [<i class="fab fa-twitch" style="color:#9146FF"></i>](https://www.twitch.tv/S1y_b0rg "Software and Game Development, Tags: English, LearningisFun, HackerMan, kalilinux, InfoSecStreams, OnlyFeet, ADHD, HackTheBox, ChillhopMusic") &nbsp; [<i class="fab fa-youtube" style="color:#C00"></i>](http://www.youtube.com/@SlyB0rg-legit) | EN
